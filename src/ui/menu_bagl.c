...
UX_STEP_NOCB(ux_menu_ready_step, pnn, {&C_icon_zcash, "Ycash", "is ready"});
UX_STEP_CB(ux_menu_address_step, bn, ui_menu_address(), {"Get", "Address"});
...
UX_STEP_NOCB(ux_menu_info_step, bn, {"Ycash", "(c) 2023 HHH"});
...
void ui_menu_address() {
    derive_default_keys();
    ux_flow_init(0, ux_menu_address_flow, NULL);
}
