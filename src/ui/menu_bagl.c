...
UX_STEP_NOCB(ux_menu_ready_step, pnn, {&C_icon_zcash, "Zcash", "is ready"});
UX_STEP_CB(ux_menu_address_step, bn, ui_menu_address(), {"Get", "UA"});
...
UX_STEP_NOCB(ux_menu_info_step, bn, {"Zcash", "(c) 2023 HHH"});
