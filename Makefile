...
DEFINES += MOD_ADD_FIX # HAVE_PRINTF PRINTF=mcu_usb_printf
#DEFINES += NO_MONTGOMERY ST33K1M5 # HAVE_PRINTF PRINTF=mcu_usb_printf
DEBUG ?= 0
ifneq ($(DEBUG),0)
    DEFINES += HAVE_PRINTF MONTGOMERY_EMU TEST
    ifeq ($(TARGET_NAME),TARGET_NANOS)
